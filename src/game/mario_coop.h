...
#define COOP_MARIO_HITBOX_SIZE 0.0f // For Mario vs. Mario collision, is a sphere at the origin point

#define COOP_MARIO_STATES_MAX 6 // Maximum amount of Marios allowed to be spawned at once
/*
