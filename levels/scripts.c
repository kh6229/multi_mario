...
const LevelScript level_main_scripts_entry[] = {
    ...
    ALLOC_LEVEL_POOL(),
    LOAD_MODEL_FROM_GEO(MODEL_BLUE_BLOCK, blue_block_geo),
    LOAD_MODEL_FROM_GEO(MODEL_RED_BLOCK, red_block_geo),
    LOAD_MODEL_FROM_GEO(MODEL_ON_OFF_BLOCK, on_off_block_geo),
    LOAD_MODEL_FROM_GEO(MODEL_JUMP_PLANE, jump_plane_geo),
    LOAD_MODEL_FROM_GEO(MODEL_DIRECTION_PLATE, direction_plate_geo),
    LOAD_MODEL_FROM_GEO(MODEL_TURN_PLANE, turn_plane_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MINI_MARIO_BUTTON, mini_mario_button_geo),
    LOAD_MODEL_FROM_GEO(MODEL_EXCLAMATION_POINT_2, exclamation_point_2_geo),
    LOAD_MODEL_FROM_GEO(MODEL_EXCLAMATION_POINT, exclamation_point_geo),
    LOAD_MODEL_FROM_GEO(MODEL_END_GATE, end_gate_geo),
    LOAD_MODEL_FROM_GEO(MODEL_MINI_MARIO, mini_mario_geo),
