...
const LevelScript level_bits_entry[] = {
	...
	AREA(1, bits_area_1),
		...
		OBJECT(MODEL_JUMP_PLANE, -838, 1939, -6261, 0, 0, 0, 0x00000000, bhvJumpPlane),
		OBJECT(MODEL_JUMP_PLANE, -1126, 2139, -6261, 0, 0, 0, 0x00000000, bhvJumpPlane),
		OBJECT(MODEL_JUMP_PLANE, -1354, 2298, -6313, 0, -90, 0, 0x00000000, bhvJumpPlane),
		OBJECT(MODEL_JUMP_PLANE, -1333, 2478, -6606, 0, 0, 0, 0x00000000, bhvJumpPlane),
		OBJECT(MODEL_JUMP_PLANE, -1612, 2478, -6826, 0, 45, 0, 0x00000000, bhvJumpPlane),
		...
		OBJECT(MODEL_TURN_PLANE, -1568, 2481, -6828, 0, 45, 0, 0x00002000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -1321, 2297, -6261, 0, -90, 0, 0x0000C000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -1311, 2479, -6606, 0, 0, 0, 0x00002000, bhvTurnPlane),
