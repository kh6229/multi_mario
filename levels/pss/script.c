...
const LevelScript level_pss_entry[] = {
	...
	AREA(1, pss_area_1),
		...
		WARP_NODE(0x02, LEVEL_BITS, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		WARP_NODE(0x03, LEVEL_LLL, 0x01, 0x0A, WARP_NO_CHECKPOINT),
		OBJECT(MODEL_NONE, 571, -193, 1429, 0, 0, 0, (0x0A << 24) | (0x01 << 16), bhvWarp),
		OBJECT(MODEL_NONE, 0, -193, 1429, 0, 0, 0, (0x0A << 24) | (0x02 << 16), bhvWarp),
		OBJECT(MODEL_BLUE_BLOCK, 1425, 0, 0, 0, 0, 0, (0x01 << 16), bhvBlueBlock),
		OBJECT(MODEL_DIRECTION_PLATE, -2000, 0, 2000, 0, 0, 0, 0x00000000, bhvDirectionPlate),
		OBJECT(MODEL_NONE, -571, -193, 1429, 0, 0, 0, (0x0A << 24) | (0x03 << 16), bhvWarp),
		MARIO_POS(0x01, 0, 0, 80, 0),
		OBJECT(MODEL_ON_OFF_BLOCK, 1125, 356, 0, 0, 0, 0, 0x00000000, bhvOnOffBlock),
		OBJECT(MODEL_ON_OFF_BLOCK, 1725, 356, 0, 0, 0, 0, 0x00000000, bhvOnOffBlock),
		OBJECT(MODEL_RED_BLOCK, 925, 0, 0, 0, 0, 0, 0x00000000, bhvBlueBlock),
