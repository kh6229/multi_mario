...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_NONE, 148, 813, 2041, 0, -180, 0, (COOP_CM_NPC << 16), bhvSpawnCoopMario),
		OBJECT(MODEL_NONE, 148, 810, 1541, 0, -180, 0, (COOP_CM_NPC << 16), bhvSpawnCoopMario),
		OBJECT(MODEL_NONE, 148, 786, 1041, 0, -180, 0, (COOP_CM_NPC << 16), bhvSpawnCoopMario),
