...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_BLACK_BOBOMB, -3477, -156, -2679, 0, 0, 0, 0x00000000, bhvBobomb),
		OBJECT(MODEL_BLACK_BOBOMB, -2669, -156, -3285, 0, 0, 0, 0x00000000, bhvBobomb),
		OBJECT(MODEL_BLACK_BOBOMB, -3705, -156, -1679, 0, 0, 0, 0x00000000, bhvBobomb),
		OBJECT(MODEL_BLACK_BOBOMB, -2980, -156, -767, 0, 0, 0, 0x00000000, bhvBobomb),
		MARIO_POS(0x01, 0, 2035, 737, 2144),
		...
		OBJECT(MODEL_EXCLAMATION_POINT_2, 2035, 149, 2144, 0, 0, 0, (0x01 << 16), bhvTextTrigger),
		OBJECT(MODEL_EXCLAMATION_POINT_2, -272, 781, 187, 0, 0, 0, (0x02 << 16), bhvTextTrigger),
		OBJECT(MODEL_EXCLAMATION_POINT_2, -1618, -156, -2679, 0, 0, 0, (0x03 << 16), bhvTextTrigger),
		...
		OBJECT(MODEL_TURN_PLANE, -3005, 1045, 2527, 0, 0, 0, 0x0000C000, bhvTurnPlane),
