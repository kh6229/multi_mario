...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_BLACK_BOBOMB, -9966, 4121, -1007, 0, 0, 0, 0x00000000, bhvBobomb),
		OBJECT(MODEL_DIRECTION_PLATE, -6876, 2426, -2602, 0, 0, 0, 0x00000000, bhvDirectionPlate),
		OBJECT(MODEL_DIRECTION_PLATE, -11376, 2457, 1729, 0, 0, 0, 0x00000000, bhvDirectionPlate),
		...
		OBJECT(MODEL_GOOMBA, -9038, 2506, -3069, 0, 0, 0, 0x00000000, bhvGoomba),
		OBJECT(MODEL_GOOMBA, -11563, 2659, 1639, 0, 0, 0, 0x00000000, bhvGoomba),
		...
		OBJECT(MODEL_TURN_PLANE, -11377, 2550, -1679, 0, 0, 0, 0x00002000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -7835, 2720, 1640, 10, 0, 0, 0x00004000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -7936, 3364, -1999, 0, 0, 0, 0x00004000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -8405, 3534, 1001, 0, 0, 0, 0x0000C000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -10285, 3991, 945, 0, 0, 0, 0x0000E000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -10849, 4200, 367, 0, 0, 0, 0x0000E000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -10822, 4177, -1139, 0, 0, 0, 0x0000C000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -9066, 4153, -1139, 0, 0, 0, 0x0000C000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -9066, 4178, -294, 0, 0, 0, 0x0000C000, bhvTurnPlane),
		...
		OBJECT(MODEL_TURN_PLANE, -10492, 2492, -2519, 0, 0, 0, 0x00002000, bhvTurnPlane),
