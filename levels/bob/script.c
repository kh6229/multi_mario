...
const LevelScript level_bob_entry[] = {
	...
	AREA(1, bob_area_1),
		...
		OBJECT(MODEL_DIRECTION_PLATE, -6876, 2362, -2602, 0, 0, 0, 0x00000000, bhvDirectionPlate),
		...
		OBJECT(MODEL_END_GATE, -9560, 4176, -371, 0, 90, 0, 0x00000000, bhvEndGate),
		...
		OBJECT(MODEL_TURN_PLANE, -7835, 2743, 1640, 10, 0, 0, 0x00004000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -7936, 3364, -1999, 0, 0, 0, 0x00004000, bhvTurnPlane),
		OBJECT(MODEL_TURN_PLANE, -8405, 3560, 1001, 0, 0, 0, 0x0000C000, bhvTurnPlane),
